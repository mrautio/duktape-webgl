...
var glTypeDukTypeParameterFunctionMap = {
    ...
    "Uint32Array": function(index) { return `duk_get_buffer_data(ctx, ${index}, NULL)` },
    "Int32List": function(index) { return `duk_get_buffer_data(ctx, ${index}, NULL)` },
    "Uint32List": function(index) { return `duk_get_buffer_data(ctx, ${index}, NULL)` },
...
var customWebGlBindingImplementations = {
    ...
    "getParameter": {"argumentCount": 1, "glVersion": "GL_VERSION_2_0"},
